...
quiver(0,0,real(n/N*(exp(1i*theta_true(1)))),imag(n/N*(exp(1i*theta_true(1)))),0,'LineWidth',1,'Color','b','LineStyle','-');
quiver(0,0,real(n/N*(exp(1i*theta_true(2)))),imag(n/N*(exp(1i*theta_true(2)))),0,'LineWidth',1,'Color','b','LineStyle','-');
...
quiver(0,0,real(EigenValue_E2(1)),imag(EigenValue_E2(1)),0,'LineWidth',1,'Color','g','LineStyle','--');
quiver(0,0,real(EigenValue_E2(2)),imag(EigenValue_E2(2)),0,'LineWidth',1,'Color','g','LineStyle','--');
