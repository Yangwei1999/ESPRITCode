...
%     quiver(0,0,real(sqrt(Delta))/2,imag(sqrt(Delta))/2,0,'LineWidth',1,'Color','r','DisplayName','Sqrt(Delta)');
    ...
    quiver(0,0,real(lameda1_DiaPair),imag(lameda1_DiaPair),0,'LineWidth',1,'Color','r','LineStyle','-');
    quiver(0,0,real(lameda2_DiaPair),imag(lameda2_DiaPair),0,'LineWidth',1,'Color','r','LineStyle','-');
