...
for ii = 1 : 6
    ...
    % 
    index1 = ii;
    quiver(0,0,real(EiValue_VListTheory(1,index1,1)),imag(EiValue_VListTheory(1,index1,1)),0,'LineWidth',1,'Color','#D95319','LineStyle','--');
    quiver(0,0,real(EiValue_VListTheory(1,index1,2)),imag(EiValue_VListTheory(1,index1,2)),0,'LineWidth',1,'Color','#D95319','LineStyle','--');
    % 
    ...
    quiver(0,0,real(EiValue_VListTheory(2,index1,1)),imag(EiValue_VListTheory(2,index1,1)),0,'LineWidth',1,'Color','#77AC30','LineStyle','--');
    quiver(0,0,real(EiValue_VListTheory(2,index1,2)),imag(EiValue_VListTheory(2,index1,2)),0,'LineWidth',1,'Color','#77AC30','LineStyle','--');
